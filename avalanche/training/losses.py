...
class MaskedCrossEntropy(SupervisedPlugin):
    ...
    def __call__(self, logits, targets):
        ...
        print("current_classes", list(self.current_classes))
        # Select only thos logits where targets is not in the current classes
        # print("targets shape", targets.shape)
        # print("targets", targets)
        # print("logits shape", logits.shape)
        # print("logits", logits)
        logits = logits[:, list(self.current_classes)]
        #print("logits shape", logits.shape)
        #import sys;sys.exit()
        return self.criterion(logits, targets)
    ...
    def adaptation(self, new_classes):
        ...
        #self.criterion = nn.CrossEntropyLoss(ignore_index= ,reduction=self.reduction)
